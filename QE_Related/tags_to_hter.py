    ...
    with open(file_path1) as fp1, open(t_output_path1, "w") as op1, tqdm(total=count) as pbar:
        ...
        for line in fp1:
            ...
            for tag in line:
                if tag == 'BAD':
                    count += 1
            op1.write(f'{count / len(line)}\n')
            pbar.update(1)


def make_fake_hter_tag():
    file_target = "/home/data_91_c/laizj/data/WMT/20/parallel/test.zh-en.en"
    file_path_t = "/home/data_91_c/laizj/data/WMT/20/parallel/sentencepiece/test.tags-None.tags"
    file_path_h = "/home/data_91_c/laizj/data/WMT/20/parallel/sentencepiece/test.hter"
